        ...
        <nav class="navbar navbar-expand top">
            <div class="container header">
                ...
                <ul class="navbar-nav right">
                    ...
                    <li class="nav-item">
                        <a href="https://www.facebook.com/oceanoapex/" target="_self" class="nav-link m-0"><i
                                class="fab fa-facebook-f m-0"></i></a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.instagram.com/oceanoapex" target="_self" class="nav-link m-0"><i
                                class="fab fa-twitter m-0"></i></a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.linkedin.com/company/oceano-apex" target="_self" class="nav-link m-0"><i
            ...
            <div class="container header">
                <a href="{{ route('home') }}" class="navbar-brand">
                    <img width="286" height="100" src="{{ asset('images/Oceano-Apex-Logo.png') }}"
                        alt="Oceano Apex" class="d-none d-sm-block desktop-logo">
                    <img width="286" height="100" src="{{ asset('images/Oceano-Apex-Logo.png') }}"
                        alt="Oceano Apex" class="d-block d-sm-none responsive-logo">
                </a>
                <div class="ml-auto"></div>
                ...
                <div class="row items">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 item">
                        ...
                        <div class="content-block paragraph">
                            <p>Oceano Apex is a boutique wealth management firm offering personalised financial
                                solutions tailored to each client's unique goals — guided by integrity, innovation, and
                                a focus on long-term growth.</p>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 item mt-4">
                        ...
                        <div class="footer-form-card">
                            ...
                            <div class="content-block action-buttons d-flex flex-column gap-2">
                                ...
                                <div>
                                    <button type="button" class="btn button w-100 text-center" data-toggle="modal"
        ...
        function initMidSliders() {
            ...
            document.querySelectorAll('.swiper-container.mid-slider').forEach(function(el) {
                ...
                new Swiper(el, {
                    loop: true,
                    centeredSlides: true,
                    /* keeps active slide centred on mobile */
                    slidesPerView: 1,
                    spaceBetween: 20,
                    speed: 500,
                ...
                <div class="modal-body">
                    <form class="row">
                        <div class="col-12 p-0 align-self-center">
                            ...
                            <div class="row">
                                <div class="col-12 p-0 input-group"><input type="search"
                                        placeholder="Enter Keywords"></div>
                            </div>
                            <div class="row">
                                <div class="col-12 p-0 input-group align-self-center"><button
                                        class="btn primary-button">SEARCH</button></div>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content full">
                ...
                <div class="menu modal-body">
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item"><a href="{{ asset('service-hedge-funds') }}" class="nav-link">HEDGE
                                FUNDS</a></li>
                        <li class="nav-item"><a href="{{ asset('service-treasury-funds') }}"
                                class="nav-link">TREASURY MANAGEMENT</a></li>
    ...
    <script>
        (function() {
            ...
            function init() {
                ...
                setTimeout(function() {
                    document.querySelectorAll('.about-style1__image, .about-style1__content').forEach(function(
                        el) {
                        var rect = el.getBoundingClientRect();

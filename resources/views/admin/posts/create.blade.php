...
<main>
    <form action="{{ route('posts.store') }}" method="POST">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Create New Post</h1>
                <p class="text-gray-500 text-sm">Compose your story and configure SEO metadata.</p>
            </div>
...
$(document).ready(function () {
    ...
    // Unified Summernote Configuration
    $('#editor').summernote({
        height: 480,
...
<style>
/* Custom overrides to smooth out native Summernote styles with workspace aesthetics */

                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="seo_description" rows="3"
                                      class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm outline-none">{{  $page->seo_description }}</textarea>
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">JSON-LD Schema</label>
                            <textarea name="schema_markup" rows="4"
                                      class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs outline-none">{{  $page->schema_markup }}</textarea>
                        </div>
